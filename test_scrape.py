...
# accountBalance = float(input("Enter Total Account Balance as float"))
accountBalance=5000
# username = str(input('Enter UserId'))
username = 'amoore'




#Collect Data - Sending GET request through Insomnia API to nfl/odds page. Data does not contain props. Will have to run this script 2x
